...
import { Dialog, DialogTitle, DialogContent, CircularProgress, TextField, MenuItem, DialogActions, Button } from "@mui/material";
...
export default function FormEstudiante({
    ...
    // const [telefono_refencia, setTelefonoReferencia] = useState(''); 
    ...
    const cargarDatos = async () => {
        ...
        try{
            ...
            console.error(err);
            alert("Error al cargar los datos de Padres");
        } finally {
            setLoading(false);
        }
    };
