...
export default function FormEstudiante({ open, onClose, onCreate }: Props) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!newErrors.identificacion && !validateCI(form.identificacion)) {
      newErrors.identificacion = "La CI debe contener solo números (5-15 dígitos)";
    }
    ...
    if (!newErrors.direccion) newErrors.direccion = validateLength(form.direccion, 5, 200, "Dirección");
    ...
    newErrors.nacionalidad = validateRequired(form.nacionalidad, "Nacionalidad");
