  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 4 }}>
      ...
      <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={2}>
        ...
        <TextField label="Teléfono" name="telefono" value={form.telefono} onChange={handleChange} required inputProps={{ maxLength: 20 }} />
        <TextField label="CI" name="identificacion" value={form.identificacion} onChange={handleChange} required inputProps={{ maxLength: 20 }} />
        <TextField label="Dirección" name="direccion" value={form.direccion} onChange={handleChange} required inputProps={{ maxLength: 200 }} />
        <TextField label="Correo" name="correo" type="email" value={form.correo} onChange={handleChange} required inputProps={{ maxLength: 100 }} />
        ...
        <Box display="flex" gap={2} justifyContent="flex-end">
          <Button variant="outlined" onClick={onClose || router.back}>Cancelar</Button>
